...
```{r include=FALSE}
Leucopogon_exolasius <- raster(here("Input/Leucopogon_exolasius.tif"))
```
...
```{r message=FALSE, warning=FALSE, include=FALSE}
L_exolasius <- leaflet(options = leafletOptions(minZoom = 5)) %>%              # Set extent of zoom.
  
  addTiles() %>%                                                                # Add basemap.
  
  addRasterImage(Leucopogon_exolasius,                                         # Add SDM.
                 colors   = pal,
                 group    = "Leucopogon exolasius",
                 layerId  = "Leucopogon exolasius", 
                 opacity  = 0.8,
  ...
  addLegend(pal    = pal,                                                       # Add legend for each layer.
            group  = "Leucopogon exolasius", 
            values = values(Leucopogon_exolasius),
  ...
  addLayersControl(overlayGroups = c("Leucopogon exolasius",                   # To turn layers on and off.
                                     "TSF",
                                     "Fire Freq"),
