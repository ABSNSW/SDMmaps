...
```{r include=FALSE}
Diuris_arenaria <- raster(here("Input/Diuris_arenaria.tif"))
```
...
```{r message=FALSE, warning=FALSE, include=FALSE}
D_arenaria <- leaflet(options = leafletOptions(minZoom = 5)) %>%              # Set extent of zoom.
  
  addTiles() %>%                                                                # Add basemap.
  
  addRasterImage(Diuris_arenaria,                                         # Add SDM.
                 colors   = pal,
                 group    = "Diuris arenaria",
                 layerId  = "Diuris arenaria", 
                 opacity  = 0.8,
  ...
  addLayersControl(overlayGroups = c("Diuris arenaria",                   # To turn layers on and off.
                                     "TSF",
                                     "Fire Freq"),
